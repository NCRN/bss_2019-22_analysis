...
FIBI_scores3 <- FIBI_scores2 %>%
  filter(Cycle=="2")
min(FIBI_scores3$FIBI)
max(FIBI_scores3$FIBI)
...
BIBI_scores3 <- BIBI_scores2 %>%
  filter(Cycle=="2")
min(BIBI_scores3$BIBI)
max(BIBI_scores3$BIBI)
...
gwmp_fibi_graph <- ggplot() +
  ...
  geom_bar(data=gwmp_fibi, aes(x=as.factor(x_axis), y=FIBI, fill=Cycle), 
           width=0.7, color="black", size=0.8, position="dodge", stat="identity") +
  scale_fill_manual(labels=c("2012 (*2009)", "2022"), values=c("gray60", "white"), name="Year") +
...
gwmp_bibi_graph <- ggplot() +
  ...
  geom_bar(data=gwmp_bibi, aes(x=as.factor(x_axis), y=BIBI, fill=Cycle), 
           width=0.7, color="black", size=0.8, position="dodge", stat="identity") +
  scale_fill_manual(labels=c("2012 (*2014)", "2022"), values=c("gray60", "white"), name="Year") +
...
rocr_bibi_graph <- ggplot() +
  ...
  geom_bar(data=rocr_bibi, aes(x=as.factor(x_axis), y=BIBI, fill=Cycle), 
           width=0.7, color="black", size=0.8, position="dodge", stat="identity") +
  scale_fill_manual(labels=c("2008, *14", "2019, ‡22"), values=c("gray60", "white"), name="Year") +
